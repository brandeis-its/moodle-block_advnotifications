...
/**
 * Contains class block_advnotifications\output\feed
 *
...
class feed implements \renderable, \templatable {
     ...
     *
     * @param string $title
     * @return \block_advnotifications\output\feed
     */
     ...
     * Add an RSS item
     *
     * @param \block_advnotifications\output\item $item
     */
     ...
     *
     * @param \block_advnotifications\output\channel_image $image
     */
